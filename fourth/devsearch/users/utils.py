...
def search_profiles(request):
    ...
    # skills = Skill.objects.filter(name__iexact=search_query) # name__iexact - точное совпадение при поиске
    skills = Skill.objects.filter(name__icontains=search_query)  # name__icontains - частичное совпадение при поиске
